...
gcc -ffreestanding -mno-red-zone -mgeneral-regs-only -I Kernel/include -c Kernel/drivers/e1000.c -o image/object/e1000.o
...
ld -T image/linker.ld -o image/EFI/BOOT/kernel.elf image/object/kernel_jump_asm.o image/object/kernel.o image/object/font_renderer.o \
      ...
      image/object/ft_nvm_bridge.o image/object/elf_loader.o image/object/e1000.o
